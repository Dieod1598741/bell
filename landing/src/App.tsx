...
function App() {
    const downloadLinks = {
        macos: "https://github.com/Dieod1598741/bell/releases/download/v1.1.0/Bell.dmg",
        windows: "https://github.com/Dieod1598741/bell/releases/download/v1.1.0/Bell.exe"
    }
