...
function App() {
    const downloadLinks = {
        macos: "https://github.com/Dieod1598741/bell/releases/download/v1.1.1/Bell.dmg",
        windows: "https://github.com/Dieod1598741/bell/releases/download/v1.1.1/Bell.exe"
    }
